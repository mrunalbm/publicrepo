...
sudo yum -y install perl-CPAN perl-Switch perl-DateTime perl-Sys-Syslog perl-LWP-Protocol-https unzip
sudo chown ec2-user:ec2-user /home/ec2-user/aws-scripts-mon
sudo echo "*/5 * * * * /home/ec2-user/aws-scripts-mon/mon-put-instance-data.pl --mem-util --mem-used --mem-avail --auto-scaling=only" >> /var/spool/cron/ec2-user
